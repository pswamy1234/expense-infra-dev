module "db" {
  source = "git::https://github.com/daws-78s/terraform-aws-securitygroup.git?ref=v1.0.0"
...
module "app_alb" {
  source = "git::https://github.com/daws-78s/terraform-aws-securitygroup.git?ref=v1.0.0?ref=v1.0.0"
  project_name = var.project_name
  environment = var.environment
